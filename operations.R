...
elec2012<-read.table(file="Elections 2012/elec2012.csv", sep=";", header=T, row.name=1)
elec2017<-read.table(file="Elections 2017/elec2017.csv", sep=";", header=T, row.name=1)
socioeco<-read.table(file="Etude socio-economique/socioeco.csv", sep=";", header=T, row.name=1)
View(elec2012)
View(elec2017)
View(socioeco)
summary(elec2012)
